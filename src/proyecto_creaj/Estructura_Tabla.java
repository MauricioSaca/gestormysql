...
public class Estructura_Tabla extends javax.swing.JFrame {
    //Bandera para el funcionamiento del comboBox
    Integer estadoCombo = 0;
    //Creacion de objetos
    Mostrar objeto_mostrar = new Mostrar();
    Mostrar_Tablas objeto_table = new Mostrar_Tablas();
    public Estructura_Tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbBD, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addGap(41, 41, 41)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(cmbTable, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 51, 204), null), "Estructura de la tabla", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 51, 204)));
    ...
    private void cmbBDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBDActionPerformed
        if(estadoCombo == 0){
           estadoCombo=1; 
            ...
            objeto_mostrar.Ver_Tablas(cmbBD, cmbTable);
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
       //Consulta
        String sqlTable ="describe "+cmbTable.getSelectedItem().toString();
        objeto_table.Ver(sqlTable, cmbBD, jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estructura_Tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
