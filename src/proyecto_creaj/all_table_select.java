...
import java.sql.*;
import cdb.edu.util.*;
public class all_table_select extends javax.swing.JFrame {
    //Bandera para el estado del Combo
    Integer estado = 0;
    //Creacion de objetos
    Mostrar objeto_mostrar = new Mostrar();
    Mostrar_Tablas  objeto_table = new Mostrar_Tablas();
    public all_table_select() {
        initComponents();
        //Al no mas se carga el form muestro las bases existentes
        objeto_mostrar.Ver(cmbBd);
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbBd, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(cmbTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 51, 204), null), "Select ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 51, 204)));
    ...
    private void cmbBdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBdActionPerformed
        if(estado==0){
            ...
            //Metedo del objeto_mostrar que visualizar las tablas de la base de datos
            objeto_mostrar.Ver_Tablas(cmbBd, cmbTabla);
            //Habilito boton
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Consulta
        String sqlSelect = "select * from "+cmbTabla.getSelectedItem().toString();
        //Metodo del objeto_table que nos muestra la estructura de la tabla
        objeto_table.Ver(sqlSelect, cmbBd, jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(all_table_select.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
